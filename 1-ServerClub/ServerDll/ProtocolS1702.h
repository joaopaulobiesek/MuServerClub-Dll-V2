...
struct SDHP_REQUEST_OFFSET_S1702_RECV
{
	HEAD_VERSION header; // C1:00
};

struct SDHP_REQUEST_KEYBOARD_S1702_RECV
{
	HEAD_VERSION header; // C1:00
};
...
struct SDHP_REQUEST_OFFSET_S1702_SEND
{
	HEAD_VERSION header; // C1:00
...
struct SDHP_REQUEST_KEYBOARD_S1702_SEND
{
	HEAD_VERSION header; // C1:00
...
class CProtocolS1702
{
public:
	void ProtocolCore(int index, BYTE head, BYTE* lpMsg, int size);
	void RequestOffSetS17(SDHP_REQUEST_OFFSET_S1702_RECV* lpMsg, int index);
	void RequestKeyBoardS17(SDHP_REQUEST_KEYBOARD_S1702_RECV* lpMsg, int index);
public:
};

extern CProtocolS1702 gProtocolS1702;
