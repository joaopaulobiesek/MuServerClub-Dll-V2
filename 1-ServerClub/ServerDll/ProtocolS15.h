...
struct SDHP_REQUEST_OFFSET_S15_RECV
{
	HEAD_VERSION header; // C1:00
};

struct SDHP_REQUEST_KEYBOARD_S15_RECV
{
	HEAD_VERSION header; // C1:00
};
...
struct SDHP_REQUEST_OFFSET_S15_SEND
{
	HEAD_VERSION header; // C1:00
...
struct SDHP_REQUEST_KEYBOARD_S15_SEND
{
	HEAD_VERSION header; // C1:00
...
public:
	...
	void RequestOffSet15(SDHP_REQUEST_OFFSET_S15_RECV* lpMsg, int index);
	void RequestKeyBoardS15(SDHP_REQUEST_KEYBOARD_S15_RECV* lpMsg, int index);
public:
};
