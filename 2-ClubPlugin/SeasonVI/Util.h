...
#define CRASH_APPLICATION_MACRO _asm _emit 0xFF _asm _emit 0x25 /*_asm _emit 0x42 _asm _emit 0x43*/ _asm _emit 0x00 _asm _emit 0x00 _asm _emit 0x00 _asm _emit 0x00
...
enum eClientDisconnectType
{
	...
	CLIENT_DISCONNECT_DETECTION_SQL = 11,
	CLIENT_DISCONNECT_DETECTION_NOT_AUTH_EXIT = 12,
	CLIENT_DISCONNECT_DETECTION_NOT_AUTH_MSG = 13,
};
