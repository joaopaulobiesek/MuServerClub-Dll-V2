...
void cSmokeEffect::Scan()
{
	CUSTOM_SMOKEEFFECT info;

	for (std::vector<CUSTOM_SMOKEEFFECT>::iterator it = gListManager.gCustomSmokeEffectListInfo.begin(); it != gListManager.gCustomSmokeEffectListInfo.end(); it++)
	{
		info.Index = it->Index;
