...
{
	if (gOffset.FileProtectAddress1 != 0 && gOffset.FileProtectAddress2 != 0)
	{
		this->m_HookFOpen = (FOPEN)gOffset.FileProtectAddress1;
		this->m_HookFClose = (FCLOSE)gOffset.FileProtectAddress2;
